...
def run():
    ...
    district = st.selectbox(
        "District", gen_options, format_func=lambda x: gen_display[x]
    )
    ...
    day = st.selectbox("Day", dep_options, format_func=lambda x: dep_display[x])
    ...
    dep_options = list(range(len(dep_display)))
    variety = st.selectbox("Variety", dep_options, format_func=lambda x: dep_display[x])
